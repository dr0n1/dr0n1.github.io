...
const knownPrefix = "<hbe-prefix></hbe-prefix>";
  ...
  const main=document.getElementById('board-ctn');     //原来没有这一行，board是文章div的id
  ...
  function hbeLoader() {
    ...
    main.addEventListener('keydown', async (event) => {    //原来是mainElement.addEventListener('keydown', async (event) => {
